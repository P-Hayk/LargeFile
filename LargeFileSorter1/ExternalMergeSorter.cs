...
namespace LargeFileSorter
{
    ...
    public class ExternalMergeSorter
    {
        ...
        public static async Task<IReadOnlyCollection<string>> SplitFile(
            Stream sourceStream,
            CancellationToken cancellationToken)
        {
            var _options = new ExternalMergeSorterOptions();
            int _maxUnsortedRows = 0;
    ...
    public class ExternalMergeSorterOptions
    {
        ...
        public string FileLocation { get; init; } = "C:/Users/hayk.poghosyan/Desktop/Files";
    ...
    public class ExternalMergeSortSplitOptions
    {
        ...
        /// </summary>
        public long FileSize { get; init; } = 3 * 1024 * 1024;
